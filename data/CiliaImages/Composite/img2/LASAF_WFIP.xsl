						...
						<TD>
							<TABLE width="100%" align="center" border="0" cellspacing="0" cellpadding="5" bgcolor="#FFFFFF">
                                ...
                                <TR style="font-family: arial, helvetica; font-size: 8pt; font-weight: normal; color: 000000; padding: 3px;">
                                    ...
                                    <TD><xsl:value-of select="FileLocation"/></TD>
								</TR>
                                <TR style="font-family: arial, helvetica; font-size: 8pt; font-weight: normal; color: 000000; padding: 3px;">
                                    <TD width="35%" >Size : </TD>			
                                ...
                                <TR style="font-family: arial, helvetica; font-size: 8pt; font-weight: normal; color: 000000; padding: 3px;">
                                    ...
                                    <TD ><xsl:value-of select="FrameCount"/></TD>
                                </TR>
					            <xsl:if test="//RelativeFocusCorrection != ' '">                                                                                                                                   
									<TR style="font-family: arial, helvetica; font-size: 8pt; font-weight: normal; color: 000000; padding: 3px;">
										<TD width="35%">Relative Focus Correction : </TD>
										<TD ><xsl:value-of select="RelativeFocusCorrection"/></TD>
									</TR>
								</xsl:if> 								
							</TABLE>
						</TD>
						<TD align="center" valign="top" rowspan="2"><A href="http://www.confocal-microscopy.com/" target="about:blank"><IMG src="LeicaLogo.jpg" border="0" alt="Leica Microsystems Heidelberg GmbH"/></A></TD>				
					</TR>
				</TABLE>
			</TD>
		</TR>
        ...
        <TR>
            <TD>
                <TABLE topmargin="0" leftmargin="0" width="100%" align="center" border="1" cellspacing="0" cellpadding="5" bgcolor="#FFFFFF">
                            <TR style="font-family: arial, helvetica; font-size: 8pt; font-weight: normal; padding: 3px;">
                                <TD colspan="2" width="35%"><xsl:call-template name="break"/></TD>
                            </TR>
                </TABLE>
            </TD>
        </TR>
			...
			<TD>
				<TABLE topmargin="0" leftmargin="0" width="100%" align="left" border="1" cellspacing="0" cellpadding="5" bgcolor="#FFFFFF">
					...
					<xsl:for-each select="Dimensions/DimensionDescription">
						<TR style="font-family: arial, helvetica; font-size: 8pt; font-weight: normal; color: 000000; padding: 3px;">
							<TD><xsl:value-of select="@DimID"/></TD>
							<TD><xsl:value-of select="@NumberOfElements"/> &nbsp; <xsl:value-of select="@LogicalUnit"/></TD>
							<TD><xsl:value-of select="@Length"/> &nbsp;<xsl:value-of select="@Unit"/></TD>
							<TD><xsl:value-of select="@Origin"/> &nbsp;<xsl:value-of select="@Unit"/></TD>
							<TD><xsl:value-of select="@Voxel"/> &nbsp;<xsl:value-of select="@Unit"/></TD>
						</TR>
					</xsl:for-each>
                ...
                <TR style="font-family: arial, helvetica; font-size: 8pt; font-weight: normal; padding: 3px;">
                    <TD width="20%">               
                        <xsl:for-each select="//ScannerSetting/ScannerSettingRecord[@Identifier='nWFChannelCount']">
                            <b>Channels used : &nbsp; <xsl:value-of select="@Variant"/> </b>
                        </xsl:for-each>
                    </TD>
                    <TD width="20%"><b>Name </b> </TD>
                    <TD width="15%"><b>Cube </b> </TD>
                    <TD width="15%"><b>Contrast Method </b></TD>
                    ...
                    <TD width="8%"><b>Peak Emission </b> </TD>
                    <TD width="9%"><b>Peak Excitation </b> </TD>
                </TR>
                <xsl:for-each select="//FluoDescription/FluoDescriptionRecord">
                  ...
                  <xsl:variable name="StereoChannelTLBasePrefix">
                    ...
                    <TR style="font-family: arial, helvetica; font-size: 8pt; font-weight: normal; padding: 3px;">
                        ...
                        <TD><xsl:value-of select="@Cube"/> &nbsp; </TD>
                        <TD><xsl:value-of select="@Contrast"/></TD>
                        ...
                        <TD><xsl:value-of select="@Emission"/> &nbsp; nm</TD>
                        <TD><xsl:value-of select="@Excitation"/>&nbsp; nm</TD>
                    </TR>
                </xsl:for-each>
                </TABLE>
            </TD>
  ...
  <TABLE width="98%" align="center" border="0" cellspacing="0" cellpadding="5" bgcolor="#DDDAD7">		
        <TR style="font-family: arial, helvetica; font-size: 8pt; font-weight: normal; padding: 3px;">
            <TD colspan="2">
                <TABLE topmargin="0" leftmargin="0" width="100%" align="center" border="1" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
                <TR style="font-family: arial, helvetica; font-size: 8pt; font-weight: normal; padding: 3px;">
                    <TD width="15%"><b>Channel Name </b> </TD>
                    <TD width="15%"><b>LUT Name </b> </TD>
                    <TD width="15%"><b>Exposure Time </b> </TD>
                    <TD width="15%"><b>Gain </b></TD>
                    <xsl:if test="//Channels/ChannelDescription2[@EMGain!='']">
                    <TD width="15%"><b>EM Gain</b></TD>
                    </xsl:if>
                    <xsl:if test="//Channels/ChannelDescription2[@RFCZPos!='']">
                    <TD width="15%"><b>Focus Position</b></TD>
                    </xsl:if>
                ...
                <xsl:for-each select="//Channels/ChannelDescription2">
                    ...
                    <TR style="font-family: arial, helvetica; font-size: 8pt; font-weight: normal; padding: 3px;">
                        <TD><xsl:value-of select="@Name"/></TD>
                        <TD><xsl:value-of select="@LutName"/></TD>
                        <TD><xsl:value-of select="@Exposure"/></TD>
                        <TD><xsl:value-of select="@Gain"/></TD>
                        <xsl:if test="//Channels/ChannelDescription2[@EMGain!='']">
                            <TD><xsl:value-of select="@EMGain"/></TD>
                        </xsl:if>
                        <xsl:if test="//Channels/ChannelDescription2[@RFCZPos!='']">
                            <TD><xsl:value-of select="@RFCZPos"/></TD>
                        </xsl:if>
                        <xsl:if test="$isColorCamera = '1'">
                        <xsl:for-each select="//ScannerSettingRecord">
		...
		<TABLE width="98%" align="center" border="0" cellspacing="0" cellpadding="5" bgcolor="#DDDAD7">		
			<TR style="font-family: arial, helvetica; font-size: 8pt; font-weight: normal; padding: 3px;">
				<TD colspan="2">
					<TABLE topmargin="0" leftmargin="0" width="100%" align="center" border="1" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
					<TR style="font-family: arial, helvetica; font-size: 8pt; font-weight: normal; padding: 3px;">
	                    <TD width="20%"><b>Channel Name </b> </TD>
						<TD width="20%"><b>Emission1 </b> </TD>
						<TD width="20%"><b>Emission2</b> </TD>
						<TD width="20%"><b>Excitation1</b> </TD>
						<TD width="20%"><b>Excitation2 </b></TD>
					</TR>
					<xsl:for-each select="//Channels/ChannelDescription3">
						<TR style="font-family: arial, helvetica; font-size: 8pt; font-weight: normal; padding: 3px;">
	                        <TD><xsl:value-of select="@Name"/></TD>
							<TD><xsl:value-of select="@FFWEmission1"/></TD>
							<TD><xsl:value-of select="@FFWEmission2"/></TD>
							<TD><xsl:value-of select="@FFWExcitation1"/></TD>
							<TD><xsl:value-of select="@FFWExcitation2"/></TD>
						</TR>
					</xsl:for-each>
					</TABLE>
				</TD>
                    ...
                    <TABLE topmargin="0" leftmargin="0" width="100%" align="center" border="1" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
                        ...
                        <TR style="font-family: arial, helvetica; font-size: 8pt; font-weight: normal; padding: 3px;">
                            ...
                            <xsl:for-each select="//FilterSetting/FilterSettingRecord[@Attribute='XPosOrigin' and @ClassName='CXYZStage']">
                                    <TD><xsl:value-of select="@Variant"/> &nbsp;<xsl:value-of select="@Unit"/> </TD>
                            </xsl:for-each>
                  ...
                  <TD >
					...
					<xsl:for-each select="//ScannerSettingRecord">
                        ...
                        <xsl:if test="@Identifier='eBinning'">
                                <TR style="font-family: arial, helvetica; font-size: 8pt; font-weight: normal; color: 000000; padding: 3px;">
                                    <TD width="40%"><xsl:value-of select="@Description"/></TD>
                                    <xsl:choose>
                                      ...
                                      <xsl:otherwise>
                                        <TD > <xsl:value-of select="@Variant"/> x <xsl:value-of select="@Variant"/> </TD>
                                      </xsl:otherwise>
                                    </xsl:choose>                                    
                                </TR>
                        </xsl:if>       
                        <xsl:if test="@Identifier='nBit'">
                            <TR style="font-family: arial, helvetica; font-size: 8pt; font-weight: normal; color: 000000; padding: 3px;">
                                <TD width="40%"><xsl:value-of select="@Description"/></TD>
                                <TD ><xsl:value-of select="@Variant"/>  &nbsp; bits</TD>
                            </TR>
                        </xsl:if>                                
          ...
          <TABLE topmargin="0" leftmargin="0" width="100%" align="left" border="1" cellspacing="0" cellpadding="5" bgcolor="#FFFFFF">
            ...
            <xsl:for-each select="//FluoDescription/FluoDescriptionRecord">
              ...
              <xsl:variable name="ChannelPrefix">
                ...
                <TR style="font-family: arial, helvetica; font-size: 8pt; font-weight: bold; color: 000000; padding: 3px;">
                  <TD>Channel <xsl:value-of select="$MyCounter" /></TD>
                </TR>
                <TR>
                  <TD>
                    <TABLE topmargin="0" leftmargin="0" width="100%" align="left" border="1" cellspacing="0" cellpadding="5" bgcolor="#FFFFFF">
                    ...
                    <xsl:if test="@ClassName='CDetectionUnit'">
                            ...
                            <xsl:choose>
                                ...
                                <xsl:when test="@Attribute = 'HighVoltage'">
                                    <TD ><xsl:value-of select="@Variant"/> &nbsp; Volt</TD>
                                </xsl:when>
                                <xsl:otherwise>
                                    <TD ><xsl:value-of select="@Variant"/></TD>
                                </xsl:otherwise>
                    ...
                    <xsl:if test="@ClassName='CScanActuator'">
                        <xsl:if test="@ObjectName='Y Scan Actuator'">
                            <xsl:if test="@Attribute='Position'">
                                <TR style="font-family: arial, helvetica; font-size: 8pt; font-weight: normal; color: 000000; padding: 3px;">
                                    <TD width="40%"><xsl:value-of select="@Description"/></TD>
                                    <TD ><xsl:value-of select="@Variant"/> &nbsp; µm</TD>
                                </TR>
                            </xsl:if>       
                        </xsl:if>       
                    </xsl:if>       
